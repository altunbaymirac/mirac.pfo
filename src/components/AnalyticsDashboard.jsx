    ...
    datasets: [
      {
        ...
        backgroundColor: ['#00ff41', '#00d9ff', '#ff6b35', '#fbbf24', '#8b5cf6'],
        borderWidth: 0,
      },
    ],
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
        <StatCard icon={Users} label="TOTAL VISITORS" value={stats.totalVisitors.toLocaleString()} trend={12.5} color="terminal-text" />
        <StatCard icon={Eye} label="TODAY'S VISITORS" value={stats.todayVisitors} trend={8.3} color="terminal-secondary" />
