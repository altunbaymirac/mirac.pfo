...
import { useRealAnalytics } from '../utils/analytics'
...
export default function AnalyticsDashboard() {
  // GERÇEK ANALYTICS
  const realStats = useRealAnalytics()
  ...
  useEffect(() => {
    // Her 5 saniyede bir localStorage'dan güncel verileri çek
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-500 mt-1">
          Live visitor statistics powered by localStorage + Vercel Analytics
        </p>
      </div>
      ...
      <div className="bg-terminal-bg border-2 border-terminal-secondary p-4">
        <p className="text-xs text-gray-400 font-mono text-center">
          💡 <strong className="text-terminal-secondary">Real Analytics:</strong> Visitor counts use localStorage. 
          For production, enable <strong>Vercel Analytics</strong> or <strong>Google Analytics</strong> in index.html
        </p>
      </div>
    </div>
  )
